...
<head>
  ...
  <style><?php include 'C:/MAMP/htdocs/php-google-faq/style.css'; ?></style>
...
<header>
  ...
  <?php 
    foreach($db as $faqItem):

      echo $faqItem['question'] . '<br>'; 
      echo $faqItem['answer'] . '<br>';
